...
class KpDetector(Job[kpDetCfg]):
    ...
    def _calc_features(self, cfg: kpDetCfg):
        ...
        self.features = {}
        query_detector = cv2.ORB_create(**cfg.query_detector.__dict__)
    ...
    def _detect(self, img: np.ndarray):
        ...
        mask = self.bg_subtractor.apply(img) if self.cfg.use_bg_subtraction else None
    ...
    def _on_input(self, msg: Image):
        ...
        if self.cfg.debug and self._markers_pub.get_subscription_count() > 0:
